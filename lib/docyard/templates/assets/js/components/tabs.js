...
class TabsManager {
  ...
  init() {
    ...
    // Delay scroll indicator check to ensure layout is fully calculated
  ...
  activateTab(index, animate = true) {
    ...
    // Determine direction for content animation
    ...
    this.panels.forEach((panel, i) => {
      ...
      // Set direction for animation (only on the newly active panel)
